...
export function AppScreen({children,className, ...props}){
    return (
        <div className={className} {...props} style={{display:'flex',flexDirection:'column'}}>
...
AppScreen.Title= forwardRef( function AppScreenTitle({ children }, ref){
    return (
        <div ref={ref} style={{fontSize:'1.5rem',lineHeight:'2rem'}}>
        {children}
        </div>
    )
}
...
AppScreen.Subtitle=forwardRef( function AppScreenSubtitle({ children }, ref){
 return (
    <div ref={ref} style={{fontSize:'0.875rem', lineHeight:'1.25rem'}}>
    {children}
    </div>
 )
}
