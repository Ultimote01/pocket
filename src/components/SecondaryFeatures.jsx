...
import "@/styles/secondaryfeatures.css"
...
function DeviceChartIcon(props) {
 ...
 export function SecondaryFeatures(){
    return(
        ...
        className="secondaryfeatures">
        <Container >
            <div className="secondaryfeaturesdiv"> 
            <h2 className="secondaryfeaturesh1">
            ...
            <ul 
            role="list"
            className="secondaryfeaturesul">
                {features.map((feature)=>(
                    <li
                    key={feature.name}
                    className="secondaryfeaturesli">
                    <feature.icon
                     className='secondaryfeaturesIcon'
                    />  
                    <h3 className="secondaryfeaturesh3">
                        {feature.name}
                    </h3>  
                    <p className="secondaryfeaturesp">{feature.description}</p>
                    </li>
                ))}
